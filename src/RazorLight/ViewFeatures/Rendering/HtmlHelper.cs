...
namespace RazorLight.ViewFeatures.Rendering
{
	...
	/// </summary>
	public class HtmlHelper: IPageContextAware
	{
		...
		private PageContext _viewContext;
		...
		/// <inheritdoc />
		public PageContext ViewContext
		{
			get
			{
		...
		{
			return FastPropertySetter.ObjectToDictionary(value);
		}
		...
		public virtual void Contextualize(PageContext viewContext)
		{
			if (viewContext == null)
			{
