...
namespace RazorLight.ViewFeatures.Rendering
{
	...
	public interface IHtmlGenerator
	{
		...
		/// </summary>
		/// <param name="PageContext">The <see cref="PageContext"/> instance for the current scope.</param>
		...
		/// </returns>
		IHtmlContent GenerateAntiforgery(PageContext PageContext);
		...
		/// attributes using <paramref name="PageContext"/> and the <paramref name="expression"/>.
		/// </param>
		...
		/// <c>PageContext.ViewData[expression]</c>.
		/// </param>
		...
		/// <summary>
		/// Generate a <paramref name="tag"/> element if the <paramref name="PageContext"/>'s
		...
		/// <see cref="PageContext.ValidationMessageElement"/>.
		/// </param>
		/// <param name="htmlAttributes">
		/// An <see cref="object"/> that contains the HTML attributes for the element. Alternatively, an
		/// <see cref="IDictionary{String, Object}"/> instance containing the HTML attributes.
		...
		/// <paramref name="PageContext"/>'s <see cref="ActionContext.ModelState"/> contains an error for the
		...
		/// </returns>
		/// <remarks><see cref="PageContext.ValidationMessageElement"/> is <c>"span"</c> by default.</remarks>
