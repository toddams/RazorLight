...
namespace RazorLight.ViewFeatures
{
	...
	public class DefaultModelMetadataProvider : ModelMetadataProvider
	{
		...
		{
			var propertyHelpers = FastPropertySetter.GetVisibleProperties(key.ModelType);
			...
			for (var i = 0; i < propertyHelpers.Length; i++)
			{
				...
				{
					var getter = FastPropertySetter.MakeNullSafeFastPropertyGetter(propertyHelper.Property);
